    ...
    <div className='faq'>
      ...
      <div>
        <div>
          ...
          <h3>How long will it take me to learn anatomy?</h3>
          <p>The length of time it will take will vary from person to person.  Audiomed allows you to work smarter and ensures that you are maximizing your learning with the time you put in.
          We are so confident that our sysytem is the best way to learn that we offer a 100% money back guarantee if you are not satisfied.</p>
        </div>
        <div>
          <h3>How does the rapid learner program help me learn faster?</h3>
